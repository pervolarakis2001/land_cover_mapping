...
gt_info = utils.get_tiff_info("data/ground_truth/GBDA24_ex2_ref_data.tif")
...
gt_info = utils.get_tiff_info("data/processed/final_tiles/tile_2.tif")
gt_crs = gt_info["crs"]
...
utils.pansharpening(
    path_pr, "/home/ubuntu/bdrs_exercise_1/data/prediction/predict_pan.tif"
)
...
utils.visualize_tif(
    "/home/ubuntu/bdrs_exercise_1/data/prediction/rep_predict_pan.tif",
    "/home/ubuntu/bdrs_exercise_1/data/pred_tile.png",
)

g = utils.get_tiff_info("data/processed/final_tiles/tile_0.tif")
print(g)
